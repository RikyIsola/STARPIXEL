...
public abstract class Tastiera extends Finestra
{
	...
	public Tastiera(Schermo schermo,int sfondo,int coloreTesto,int colore1,int colore2,CharSequence testo)
	{
		...
		new Bottone(gruppo,8,9,9,10,colore1,colore2).scrivi(Lista.cancella,coloreTesto).setOnClickListener(scrittura);
	...
	public Tastiera versioneNumerica()
	{
		...
		gruppo.colore(sfondo);
		scritta=new Testo(gruppo,0,3,3,4,testo.toString(),coloreTesto,sfondo);
		...
		new Bottone(gruppo,2,9,3,10,colore1,colore2).scrivi(Lista.cancella,coloreTesto).setOnClickListener(scrittura);
		gruppo.aggiorna();
		return this;
	}
